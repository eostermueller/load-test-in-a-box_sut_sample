package com.github.eostermueller.tjp2.dataaccess_1;
...
public class AccountMgr1 implements BaseManager {
	...
	public Accounts getAllAccountsAndCrashJvm() throws PerfSandboxException   {
		...
		try {
			con = getAppContext().getConnection();
	...
	public Accounts getAccounts_joinToHistoryTable() throws PerfSandboxException {
		List<Long> accountIdsCriteria = this.getAppContext().getRandomAccountIds(NUM_ACCOUNTS);
